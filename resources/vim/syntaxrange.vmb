...
function! SyntaxRange#Get( range )
"******************************************************************************
"* PURPOSE:
...
function! SyntaxRange#SyntaxIgnore( startLnum, endLnum )
    let [l:startLnum, l:endLnum] = [SyntaxRange#NetStart(a:startLnum), SyntaxRange#NetEnd(a:endLnum)]
